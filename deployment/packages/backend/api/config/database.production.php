...
class Database {
    ...
    private $host = "sql.infinityfree.com"; // Change this to your actual InfinityFree MySQL host
    private $db_name = "epiz_your_db_name"; // Change this to your actual database name
    private $username = "epiz_your_username"; // Change this to your actual database username
    private $password = "your_password"; // Change this to your actual database password
    private $conn;
